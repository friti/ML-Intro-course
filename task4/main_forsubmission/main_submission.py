...
#Uncomment to define train and validation and test uncorrelated (all images different)
...
def fit(model_name, params, features_array):
    ...
    return model,best_cut


def predict(model, features_array,best_cut):
...
if __name__ == "__main__":
    ...
    model, best_cut = fit(model_name, params, features_array)
    predict(model, features_array, best_cut)
